# File Editing — Буквальное выполнение и защита файлов

**Доменное правило.** Применять при любой работе с файлами.

---

## Буквальное выполнение запросов [MANDATORY]
...
## Бэкапы и подтверждения [MANDATORY]
