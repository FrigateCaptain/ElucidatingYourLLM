...
Правила для Claude Code из **ElucidatingYourLLM** (14 правил: 11 основных + 3 по условию).
...
- `.claude/rules/*.md` — правила для конкретных задач (загружаются автоматически по условию: glob-паттерну файлов или всегда, если glob не задан)
